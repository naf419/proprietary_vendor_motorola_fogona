...
kernel_so_list=("/vendor/lib/modules/$GKI_PATH/fpc1020_mmi.ko" "/vendor/lib/modules/$GKI_PATH/fpsensor_spi_tee_v1.ko")
kernel_so_name_list=("fpc1020_mmi.ko" "fpsensor_spi_tee_v1.ko")
